...
const Bid = sequelize.define(
  'Bid',
  {
    ...
    recipientId: { type: DataTypes.UUID, allowNull: true, field: 'recipient_id' },
    transportPrice: { type: DataTypes.FLOAT, allowNull: false, field: 'transport_price' },
    pricingMode: { type: DataTypes.ENUM('per_km', 'fixed_trip'), allowNull: false, defaultValue: 'fixed_trip', field: 'pricing_mode' },
